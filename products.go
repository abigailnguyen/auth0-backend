...
/*	The product  handler will be called when the user makes a GET request to the /products endpoint
...
*	so that as long as the request is successful and we can match a product to our catalog
*	of products we'll return an OK status
 */
var AddFeedbackHandler = http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
	var product Product
	vars := mux.Vars(r)
	slug := vars["slug"] // slug is the data coming from the router server
